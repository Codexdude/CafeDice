  ...
  return (
    <>
        <section className="text-gray-600 body-font">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div className="flex justify-center">
                    <button className="inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg">About Us</button>
                    <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Locate Us</button>
                </div>
                </div>
                ...
                <Image
                    ...
                    alt="hero"
                    src="https://www.brooklynpaper.com/wp-content/uploads/2020/01/IMG_2216.jpg?resize=720,600"
                    width={720}
                    height={600}
                />
                </div>
        ...
        <div className="flex flex-wrap">
            ...
            <a href="#" className="text-yellow-500 inline-flex items-center">Learn More
        ...
        <button className="flex mx-auto mt-16 text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">Contact Us</button>
        </div>
    </section>
  </>
  )
